...
| Brayden Uglione | @BrantisIsHacking | Updated text-cleaning and chunking notebooks, consolidated data-cleaning files, and supported testing; developed task delegation and progress tracking, and managed GitHub commits and merges |
